...
plot_variation <- function(data, column.values = "Intensity", Comparison = transition_group_id + 
    Condition ~ BioReplicate, fun.aggregate = NULL, label = FALSE, title = "cv across conditions", 
    boxplot = TRUE, ...) {
