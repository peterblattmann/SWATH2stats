#' Plot fdr metrics for multiple mscore levels.
#'
#' This function provides a set of plots for the assays, peptides, and proteins
#' comprising the number of observations and the mscore hit-rate for each mscore
#' threshold provided.
#'
#' @param x  Data structure generated by sample_annotation()
#' @param output  Send the results to a pdf or the R console?
#' @param filename  When printing to a file, what file?
#' @param plot_mscore_levels  Character list containing the threshold(s) to
#'   plot.
