...
The stable release package SWATH2stats can be directly installed from Bioconductor using the commands below. This file here was generated using the current development release SWATH2stats v.1.1.11 that can be downloaded from http://bioconductor.org/packages/devel/bioc/html/SWATH2stats.html.
